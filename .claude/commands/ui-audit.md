...
```
Examples:
  /ui-audit http://localhost:3001/papers/new           → Audit on mobile (default)
  /ui-audit http://localhost:3001/papers/new --both     → Audit on mobile + desktop
  /ui-audit http://localhost:3001/papers/new --desktop   → Audit on desktop only
